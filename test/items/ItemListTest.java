...
public class ItemListTest {
    ...
    //Initiliaze and instantiate second item
    Item it1 = new Item(itemNo,room, category, type, make,model,serial, receipt, photo, value, comments);

    //Create two empty ItemLists, one for testing and one to remain empty for assertions
    ItemList il = new ItemList();
    ItemList emptyList = new ItemList();

    //Create a list and add item for assertions comparing to a non-empty list
    ...
    //Testing for add and delete item methods
    @Test
